...
{
    "COORD_RANGE1": {"name": "Coord1ScalingThresholds"},
    "COORD_DIST1": {"name": "Coord1ScalingThresholds"},
    "COORD_RANGE2": {"name": "Coord1ScalingThresholds"},
    "COORD_DIST2": {"name": "Coord1ScalingThresholds"},
    "TelemSrcSel": {"name": ".//TelemetryExchange/TelemSrcSel"},
    "DownstreamEXCH": {},
    "LocalEXCH": {},
    "RemoteEXCH": {}
}

# IF EXCH: split on EXCH and grab [0], Make two values
# split[0]+Weight and +ShiftBias. 
# 0 should be 0, 0 and 1 should be 1 4?
# Or opposite?

# OPAFM='/etc/opa-fm/opafm.xml'
# Put it in the tmp folder
# JUST MAKE SURE THERE'S an OPAFM_ORIG.xml
OPAFM='/Users/dmagee/software/hpchw/protofat/fmconfigs/jfisopa/fgar-jfisopa.xml'
OPABASE='/Users/dmagee/software/hpchw/protofat/fmconfigs/jfisopa/fgar-jfisopa.xml'
...
def experiment_map(elem_dict):
    ...
    # DownstreamEXCH,LocalEXCH,RemoteEXCH
